...
void followLine() {
  while(true) {
    ...
    if (lineSensorValues[1] < 300 && lineSensorValues[3] < 300 && lineSensorValues[2] > 200 ) {
      ...
      // "readCalibrated()" reads the linesensor values. the values span from 0-1000, the higher the value, the more color contrast.
      lineSensors.readCalibrated(lineSensorValues); 
      ...
      else if (lineSensorValues[2] < 200 && lineSensorValues[1] > 500 && lineSensorValues[3] > 500) {
        regulatedSpeed = 100;
      }
    }
  }
